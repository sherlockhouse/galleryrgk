...
public class MediaData {
    ...
    public static enum MediaType {
        INVALID, NORMAL, VIDEO, GIF, DRM , DEPTH_IMAGE, RAW
    }
    ...
    public static final int IMAGE_INDEX_IS_BEST_SHOT = 16;
    public static final int IMAGE_INDEX_DEPTH_IMAGE = 17;
    ...
    public String toString() {
        ...
        sb.append("depth_image = " + depth_image + "]");
        return sb.toString();
    }
    ...
    public static MediaData parseImage(Cursor cursor) {
        ...
        data.depth_image = cursor.getInt(IMAGE_INDEX_DEPTH_IMAGE);
