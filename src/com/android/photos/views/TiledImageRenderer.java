...
public class TiledImageRenderer {
	...
	//modify for small screen 480*800 such as 40030 start BSLLSL-1030
    private static final int HIGT_RESOLUTION_TILESIZE = 512;
    private static final int LOW_RESOLUTION_TILESIZE = 256;
    //modify for small screen 480*800 such as 40030 end BSLLSL-1030
    public static int suggestedTileSize(Context context) {
        return isHighResolution(context) ? HIGT_RESOLUTION_TILESIZE : LOW_RESOLUTION_TILESIZE; //BSLLSL-1030
    }
