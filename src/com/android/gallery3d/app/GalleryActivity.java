...
public final class GalleryActivity extends AbstractGalleryActivity implements OnCancelListener {
    ...
    private FrameLayout voiceViewContainer;
    //(end)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        voiceViewContainer = (FrameLayout) findViewById(R.id.voice_view_container);
        //(end)
        //A:JLLBLS-401 guoshuai 20151020(start)
            findViewById(R.id.gallery_root).setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_STABLE
        ...
        if (getStateManager().getStateCount() != 0) {
            ...
            for (int i = 0; i < permissions.length; i++) {
                if (Manifest.permission.READ_EXTERNAL_STORAGE.equals(permissions[i])
                    ...
                    PermissionHelper.showDeniedPromptForTecno(this);
                    break;
                }
...
//            finish();
    ...
    public void addView(View view) {
    	voiceViewContainer.addView(view);
    	voiceViewContainer.setVisibility(View.VISIBLE);
    }
    
    public void removeView(View v) {
    	voiceViewContainer.removeView(v);
    	voiceViewContainer.setVisibility(View.GONE);
    }
    
    @Override
    public VoicePlayerManager getVoicePlayerManager() {
