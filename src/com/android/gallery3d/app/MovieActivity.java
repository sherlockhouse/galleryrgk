...
import com.android.gallery3d.rgk.airview.RgkMoviePlayer;
...
public class MovieActivity extends Activity {
    ...
    protected IActivityHooker mMovieHooker;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!getIntent().getAction().toString().equals(ACTION_VIEW_LOCKED_FILE)
              &&  getResources().getBoolean(R.bool.enable_airview)) {
        	setContentView(R.layout.rgk_movie_view);   
        } else {
        ...
        if (!getIntent().getAction().toString().equals(ACTION_VIEW_LOCKED_FILE)
              &&  getResources().getBoolean(R.bool.enable_airview)) {
        	mPlayer = new RgkMoviePlayer(rootView, this, mMovieItem,
