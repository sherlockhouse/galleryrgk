...
public class PhotoDataAdapter implements PhotoPage.Model {
    ...
    private class FullImageListener
        ...
        public FullImageListener(MediaItem item) {
            mPath = item.getPath();
            mItem = item; //add by songqingming for voice photo
        }
        ...
        public void run() {
            ...
            if (mPhotoLoadListener != null) {
            	mPhotoLoadListener.onPhotoLoaded(mItem);
            }
            //(end)
    ...
    public void setPhotoLoadListener(PhotoLoadListener listener) {
    	mPhotoLoadListener = listener;
    }
    public interface PhotoLoadListener {
    	void onPhotoLoaded(MediaItem item);
    }
    //(end)
}
