        ...
        private void setDetails(Context context, MediaDetails details) {
            ...
            for (Entry<Integer, Object> detail : details) {
                ...
                switch (detail.getKey()) {
                    ...
                    if (value.contains("emulated/0")) {
                        value = value.replace(
                                "emulated/0",
                                context.getResources().getString(
                                        R.string.phone_storage));
                    } else {
                        // DELSLMY-821 gulincheng 20160318 (start)
                        String test[] = value.split("/");
                        test[2] = context.getResources().getString(
                        ...
                        // value= value.replace("sdcard1",
                        // context.getResources().getString(R.string.sdcard_storage));
                        // DELSLMY-821 gulincheng 20160318 (end)
                    }
