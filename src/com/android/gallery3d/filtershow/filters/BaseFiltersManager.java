...
public abstract class BaseFiltersManager implements FiltersManagerInterface {
    ...
    public void addEffects() {
        ...
        /// M: [BUG.MARK] Platform app can not access /data dir due to N latest SELinux rule.
        // thus filtershow can not access RenderScript lib in /data/data dir.
        // so disable these effects which are implemented by RenderScript. @{
    ...
    public void addTools(Context context) {
        ...
        int[] textId = {
                ...
                R.string.rotate,
                R.string.mirror,
                /// M: added for the tool of "Draw " translate.
                R.string.imageDraw
        };
        ...
        int[] overlayId = {
              ...
              /// M: added for the tool of "Draw " translating.
                R.drawable.filtershow_button_colors
        };
