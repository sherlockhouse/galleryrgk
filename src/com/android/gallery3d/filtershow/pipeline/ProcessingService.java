...
public class ProcessingService extends Service {
    ...
    // gulincheng 20160505 DWYSEM-267 start
    private static final boolean SHOW_IMAGE = true;
    // gulincheng 20160505 DWYSEM-267 end
    ...
    public void handleSaveRequest(Uri sourceUri, Uri selectedUri,
        ...
        */
        mImageSavingTask.saveImage(sourceUri, selectedUri, destinationFile,
                preset, previewImage, flatten, quality, sizeFactor, exit, mFiltershowActivity.getVoiceBytes());
        //(end)
    }
    ...
    /**
     * Set whether HighresRenderingTask is delayed task. <br/>
     * Ref ProcessingTask.isDelayedTask().
     * @param isDelayed whether delayed.
     */
    public void setHighresRenderingDelayed(boolean isDelayed) {
        mHighresRenderingRequestTask.setDelayed(isDelayed);
    }
}
