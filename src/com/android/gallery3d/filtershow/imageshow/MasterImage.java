...
public class MasterImage implements RenderingRequestCaller {
    ...
    public void available(RenderingRequest request) {
        ...
        if (request.getType() == RenderingRequest.HIGHRES_RENDERING) {
            /// M: [BUG.ADD] Recover HighresRenderingTask to be "delayed" @{
            setHighresRenderingDelayed(true);
            /// @}
            mBitmapCache.cache(mHighresBitmap);
    ...
    void setHighresRenderingDelayed(boolean isDelayed) {
        mActivity.getProcessingService().setHighresRenderingDelayed(isDelayed);
    }
}
