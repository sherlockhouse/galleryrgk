...
public class LocalAlbum extends MediaSet {
    ...
    public static String getLocalizedName(Resources res, int bucketId,
        ...
        } else if (bucketId == MediaSetUtils.STEREO_CLIPPINGS_BUCKET_ID) {
            return res.getString(R.string.m_clippings);
        /// @}
         //gulincheng 20160506 DWYSLM-449 start
        }else if(bucketId == MediaSetUtils.PHONE_BUCKET_ID) {
            return res.getString(R.string.phone_storage);
        } else if(bucketId == MediaSetUtils.SDCARD_BUCKET_ID){
            return res.getString(R.string.sdcard_storage);
        //gulincheng 20160506 DWYSLM-449 end
        } else {
            return name;
        }
    }
