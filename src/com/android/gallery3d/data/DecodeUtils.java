...
public class DecodeUtils {
    ...
    public static Bitmap decodeThumbnail(
        ...
        // Modifed {to make  slideshow clear in screenshot, but not in camera picture or other high quality photos
        if (scale <= 0.3) result = BitmapUtils.resizeBitmapByScale(result, scale, true);
        //} Modifed end
