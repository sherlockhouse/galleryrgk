...
public class MediaSetUtils {
    ...
    */
    ...
    public static int PHONE_BUCKET_ID = GalleryUtils.getBucketId(
            "/storage/emulated/0");
    public static int SDCARD_BUCKET_ID = GalleryUtils.getBucketId(
    		FeatureHelper.getExternalStoragePath());
    ...
    public static void refreshBucketId() {
        ...
        SDCARD_BUCKET_ID = GalleryUtils.getBucketId(
        		FeatureHelper.getExternalStoragePath());
        //gulincheng 20160506 DWYSLM-449 end
