...
public class MediaPlayerWrapper implements MediaPlayer.OnErrorListener,
	...
	//add bug_id:DWEQLSY-588 liqiang 20161019 start
    private AudioManager mAudioManager;
    private float mCurrentVolume = 1.0f;
    private static final int FADEDOWN = 5;
    private static final int FADEUP = 6;
  //add bug_id:DWEQLSY-588 liqiang 20161019 end
    ...
    protected static int KEY_PLAYBACK_PARAMETER = 2100;
    protected static int MTK_PLAYBACK_VALUE = 1;
    // / @}
    ...
    protected Object mSurfaceWidth;
    protected Object mSurfaceHeight;
    ...
    protected MultiWindowListener mMultiWindowListener;
    ...
    private Handler mMediaPlayerHandler = new Handler(){
    	public void handleMessage(Message msg){
			...
			case FADEDOWN:
				...
				Log.v("MediaPlayerlq","====FADEDOWN===="+mCurrentVolume);
			...
			case FADEUP:
				...
				Log.v("MediaPlayerlq","====FADEUP===="+mCurrentVolume);
				mMediaPlayer.setVolume(mCurrentVolume);
				break;
			default:
				break;
	...
	public void setDownRingtones(int i,int j) {
		mMediaPlayerHandler.removeMessages(j);
		mMediaPlayerHandler.sendEmptyMessage(i);
		
    }
	public void setUpRingtones(int i, int j){
		mMediaPlayerHandler.removeMessages(i);
		mMediaPlayerHandler.sendEmptyMessage(j);
	}
	//add bug_id:DWEQLSY-588 liqiang 20161019 end
}
