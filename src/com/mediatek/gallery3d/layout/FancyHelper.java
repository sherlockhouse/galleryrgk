...
public class FancyHelper {
    ...
    public static void doFancyInitialization(int widthPixel, int heightPixel) {
        ...
        MtkLog.i(TAG, "<doFancyInitialization> <Fancy> w x h: " + sWidthPixels + ", "
                + sHeightPixels);
    ...
    private static Bitmap decodeThumbnail(JobContext jc, FileDescriptor fd, Options options,
        ...
        MtkLog.d(TAG, "<decodeThumbnail> decoding bmp's bounds begins at" + logTimeBeforDecode);
        BitmapFactory.decodeFileDescriptor(fd, null, options);
        MtkLog.d(TAG,
                "<decodeThumbnail> decoding bmp's bounds costs "
        ...
        MtkLog.d(TAG, "<decodeThumbnail> set samplesize to " + options.inSampleSize);
        options.inJustDecodeBounds = false;
        setOptionsMutable(options);

        logTimeBeforDecode = System.currentTimeMillis();
        MtkLog.d(TAG, "<decodeThumbnail> decoding bmp begins at" + logTimeBeforDecode);
        Bitmap result = BitmapFactory.decodeFileDescriptor(fd, null, options);
        MtkLog.d(TAG, "<decodeThumbnail> decoding bmp costs "
                + (System.currentTimeMillis() - logTimeBeforDecode));
        ...
        if (scale <= HALF_SCALE) {
            MtkLog.d(TAG, "<decodeThumbnail> resize down to scale " + scale);
