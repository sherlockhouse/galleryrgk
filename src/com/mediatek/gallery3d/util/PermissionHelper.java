...
public class PermissionHelper {
    ...
    public static boolean checkStoragePermission(Context context) {
        ...
        MtkLog.i(TAG, "<checkStoragePermission> writeGranted = " + writeGranted
    ...
    public static void showDeniedPromptForTecno(Activity activity) {
     /*   Dialog alertDialog = new AlertDialog.Builder(activity).
                setTitle(android.R.string.dialog_title).
                setMessage(android.R.string.dialog_message).
                setPositiveButton(android.R.string.goto_setting, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        activity.getPackageManager().startManagePermissionsActivity(activity.getPackageName()); 
                    }   
        ...
        public static void showDeniedPromptForTecnoDismiss(Activity activity) {
            PermissionDialog permissionDialog =  new PermissionDialog(activity) {
