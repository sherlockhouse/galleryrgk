...
LOCAL_C_INCLUDES += \
    $(JNI_H_INCLUDE) \
    $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/legacy/platform/$(shell echo $(MTK_PLATFORM) | tr '[A-Z]' '[a-z]')/include/mtkcam/algorithm/libfv3d
else
LOCAL_C_INCLUDES += \
    $(JNI_H_INCLUDE) \
    $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/include/algorithm/$(shell echo $(MTK_PLATFORM) | tr '[A-Z]' '[a-z]')/libfv3d
endif
